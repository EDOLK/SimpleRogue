...
public class SkillEntry implements HasName {

    Map<Ability, Integer> abilityRequirements;
    Map<Attribute, Integer> attributeRequirements;
    Map<SkillTree, Integer> skillTreeRequirements;
    Map<Skill, Integer> skillRequirements;
    Consumer<Entity> applyFunction = (e) -> {};
