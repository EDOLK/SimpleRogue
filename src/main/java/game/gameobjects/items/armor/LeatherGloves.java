...
public class LeatherGloves extends Armor {
    ...
    public LeatherGloves(){
        ...
        getResistances().add(new RangeResistance(DamageType.PIERCING, 0, 1, this, 1, 1));
        getResistances().add(new RangeResistance(DamageType.SLASHING, 0, 1, this, 1, 1));
        getResistances().add(new RangeResistance(DamageType.BLUNT, 0, 1, this, 1, 1));
